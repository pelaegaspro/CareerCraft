...
class TeamGenerationState {
  ...
  TeamGenerationState copyWith({
    ...
    Set<String>? captainLockIds,
    Set<String>? captainAvoidIds,
    ...
    return TeamGenerationState(
      ...
      captainLockIds: captainLockIds ?? this.captainLockIds,
      captainAvoidIds: captainAvoidIds ?? this.captainAvoidIds,
